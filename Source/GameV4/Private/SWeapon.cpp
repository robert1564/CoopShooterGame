...
FAutoConsoleVariableRef CVARDebugWeaponDrawing(
	TEXT("GameV4.DebugWeapons"),
	DebugWeaponsDrawing,
	TEXT("Deseneaza o linie de debug"),
	ECVF_Cheat);
...
void ASWeapon::PlayImpactEffects(EPhysicalSurface SurfaceType, FVector ImpactPoint)
{
	...
	if (SelectedEffect)
	{
		...
		UGameplayStatics::PlaySoundAtLocation(GetWorld(), ImpactSound, ImpactPoint, ShotDirection.Rotation());
	}
}
